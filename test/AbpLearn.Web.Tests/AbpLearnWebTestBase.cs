...
{
    public abstract class AbpLearnWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AbpLearnWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AbpLearnWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AbpLearnDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AbpLearnDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AbpLearnDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AbpLearnDbContext, Task<T>> func)
        {
            T result;
