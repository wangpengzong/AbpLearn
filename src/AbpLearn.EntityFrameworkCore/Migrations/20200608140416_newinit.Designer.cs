...
namespace AbpLearn.Migrations
{
    ...
    [Migration("20200608140416_newinit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbpLearn.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AbpLearn.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AbpLearn.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AbpLearn.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AbpLearn.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("AbpLearn.Authorization.Roles.Role", b =>
                {
                    b.HasOne("AbpLearn.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("AbpLearn.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("AbpLearn.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
